...
# --------------------------------------------------
# 31. Write at least 3 key insights from the data
# 32. Suggest 2 actions based on your analysis

# --------------------------------------------------
# SECTION 8: PRESENTATION (OPTIONAL)
# --------------------------------------------------
# 33. Explain your findings in simple words:
#     - What did you learn?
#     - What surprised you?
...
# BONUS (OPTIONAL)
# --------------------------------------------------
# - Predict which student will score highest
# - Suggest improvements for low-performing students

# --------------------------------------------------
# NOTE:
# Focus on understanding and explaining insights, not just writing code.